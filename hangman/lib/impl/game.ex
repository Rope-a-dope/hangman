defmodule Hangman.Impl.Game do
  ...
  def valid_guessed_letter?(guess) do
    String.length(guess) == 1 and "a" <= guess and guess <= "z"
  end
  ...
  defp reveal_guessed_letters(game = %{game_state: :won}) do
    game.letters
  end
  ...
  defp maybe_reveal(_, _letter_), do: "_"
end
